...
## Build
To compile the extension from source, you need to have Java and Maven installed, as well as [TLS-Attacker](https://github.com/RUB-NDS/TLS-Attacker) in Version 2.6 and [TLS-Scanner](https://github.com/RUB-NDS/TLS-Scanner) in Version 2.4.
```bash
$ mvn clean package
```
